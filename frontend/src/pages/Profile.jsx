    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-4 justify-center items-center min-h-screen px-4 text-center">
                <div
                    class="relative rounded-xl overflow-hidden flex flex-col items-center shadow-lg bg-white font-Roboto-light w-1/4"
                >
                    <div class="h-24 w-full bg-red-600"></div>
                    <div class="top-16 z-10 flex items-center flex-col gap-4 px-5 py-5">
                        ...
                        <div class="flex items-center flex-col">
                            <p title="name/نام" class="text-black font-Roboto-md text-3xl">{name}</p>
                            <p title="bio/بیوگرافی" class="text-gray-500 font-medium text-xl">
                                {email}
                            </p>
                        </div>
